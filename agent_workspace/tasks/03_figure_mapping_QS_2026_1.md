...
- `F:\내 드라이브\EXTRACT-TEST\QS_2026_1\total_figure_mapping.json`
...
## Validation Command
```bash
python Agent_Task_Runner.py validate --stage 03_figure_mapping --paper-folder "F:\내 드라이브\EXTRACT-TEST\QS_2026_1"
```
