...
- Excel files under `F:\내 드라이브\EXTRACT-TEST\QS_2026\Exp_Excel`
...
- `F:\내 드라이브\EXTRACT-TEST\QS_2026\Exp_Excel_Blocks`
- `F:\내 드라이브\EXTRACT-TEST\QS_2026\excel_block_inventory.csv`
- `F:\내 드라이브\EXTRACT-TEST\QS_2026\three_core_result_all.json`
...
## Validation Command
```bash
python Agent_Task_Runner.py validate --stage 03_split_excel_blocks_batch --paper-folder "F:\내 드라이브\EXTRACT-TEST\QS_2026"
```
