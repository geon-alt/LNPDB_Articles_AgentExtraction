...
Target paper folder: `F:\내 드라이브\EXTRACT-TEST\QS_2026_2`

## Stage Purpose
Match selected figure/table items to Excel blocks by direct CLI agent judgment without Gemini.

## Required Input Files
- `F:\내 드라이브\EXTRACT-TEST\QS_2026_2\.manual_select_review_done`
- `F:\내 드라이브\EXTRACT-TEST\QS_2026_2\fig_table_lnpdb_classified.csv`
- `F:\내 드라이브\EXTRACT-TEST\QS_2026_2\fig_table_inventory.csv`
- `F:\내 드라이브\EXTRACT-TEST\QS_2026_2\excel_block_inventory.csv`

## Expected Output Files
- `F:\내 드라이브\EXTRACT-TEST\QS_2026_2\excel_mapping.json`
- `F:\내 드라이브\EXTRACT-TEST\QS_2026_2\excel_mapping_rows.csv`
- updated `F:\내 드라이브\EXTRACT-TEST\QS_2026_2\fig_table_lnpdb_classified.csv` when possible
...
## Validation Command
```bash
python Agent_Task_Runner.py validate --stage 04_ft_excel_matcher --paper-folder "F:\내 드라이브\EXTRACT-TEST\QS_2026_2"
```
